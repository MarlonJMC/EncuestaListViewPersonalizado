    ...
    public View getView(int position, View ConvertView, ViewGroup viewGroup){
        if(ConvertView==null){
            ...
            try{
                ...
                txtF.setText("Femenino:"+DataSources.get(position).getcF());
                txtM.setText("Masculino:"+DataSources.get(position).getcM());
                txtO.setText("Otros:"+DataSources.get(position).getcO());
                txtLugares.setText(DataSources.get(position).DevolverLugares());
                if(txtCategoria.getText().toString().equals("COMIDA RAPIDA")){
                    img.setImageResource(R.drawable.letterr);
                }else {
                    if(txtCategoria.getText().toString().equals("MARISCOS")){
